...
// `Modal` renders inline rather than through a portal, so its scrim covers the
// element that establishes its containing block — put it at the root of a
// full-height page tree, exactly as the doc says.
...
export const CancelPolicyWarning = () => (
  <div style={pageRoot}>
    ...
    >
      Policy KV-4471-0098 for Marcus Reyes ends today. Centurion Mutual refunds $1,214 pro-rata to
      Beacon Auto Group within 10 business days, and the $118.40/mo payments stop after the next cycle.
    </Modal>
  </div>
);
    ...
    >
      <div style={{ display: 'grid', gap: 16 }}>
        ...
        <TextField
          ...
          mono
          defaultValue="OH-RS4471098"
          hint="Verified against the state DMV feed at bind."
        />
      </div>
    </Modal>
  </div>
